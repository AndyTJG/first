...
/**function format_rupiah($rp) {
  ...
  return $hasil;
    ...
    **/
$db_host = "sql204.byethost3.com";
$db_user = "b3_28822016";
$db_pass = "dawel123@";
$db_name = "b3_28822016_db_keuangan";
...
?>
      ...
      <div class="content-wrapper">
            ...
            <?php
              if(isset($_GET['submit'])){
                ...
                $selesai = $_GET['akhir'];
                     ...
                     $sql="select * FROM tb_kasmasuk INNER JOIN pengguna ON tb_kasmasuk.id_user = pengguna.id_user 
                     AND tb_kasmasuk.tgl_masuk BETWEEN '$mulai' AND '$selesai' ORDER BY tb_kasmasuk.id_trx DESC";
        ...
        <div class="row">
          ...
          <table id="lookup" class="table-striped" align="Left" border="1" cellpadding="2" cellspacing="0" >
                  ...
                  <thead>
                      ...
                      <th width="60"  ><center>No</center></th>
                        ...
                        <th width="110"  ><center>Tanggal</center></th>
                         <th  width="160" ><center>keterangan</center></th>
                      
                         <th  width="160" ><center>Kas Masuk</center></th>
...
<td><center><?php echo $data['keterangan'];?></center></td>
               ...
               <table id="lookup" class="table-striped" align="right" border="1" cellpadding="2" cellspacing="0" >
                  ...
                  <thead>
                      <tr>
                          ...
                          <th  width="110" ><center>tgl keluar</center></th>
                         <th  width="170" ><center>keterangan</center></th>
                         <th  width="210" ><center>Kas Keluar</center></th>
                    ...
                    <tr>            
                     ...
                     <td><center><?php echo $datas['tgl_keluar'];?></center></td>
                      ...
                      <td><center><?php $harga = $datas['jumlah_keluar']; echo number_format($harga,0,".","."); ?></center></td>
                  ...
                  ?>
                   ...
                   <th colspan="2" class="text-center">Total Keluar </th>

                                    <td><center>Rp.<?php echo $subtotals; ?></center></td>
