    ...
    <div class="wrapper">
      ...
      ?>
                  ...
                  <?php
                    ...
                    $query1="select * from pengguna WHERE username='$_SESSION[username]'  ORDER BY nama ASC";
                 ...
                 or nama like '%$qcari%'  ";
                  ...
                  <thead>
                    ...
                    <td><center><?php echo $data['username'];?></center></td>
                      ...
                      <td><center><img src="../admin/<?php echo $data['gambar'] ?>" class="img-rounded" height="100" width="150" style="border: 2px solid #666666;" /></td>


                        <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Ubah Data " href="edit_user.php?aksi=edit&id_user=<?php echo $data['id_user'];?>"><span class="glyphicon glyphicon-edit"> </span></a>  
