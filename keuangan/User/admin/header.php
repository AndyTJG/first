<header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-lg"><b>Bengkel </b> Savana</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo $_SESSION['nama_kasir']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <a href="logout.php" class="btn btn-default btn-flat" onclick="return confirm ('Apakah Anda Ingin Keluar.?');"> Keluar </a>
                    </div>
                  </li>
                </ul>
              </li>
