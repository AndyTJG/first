                ...
                <table id="lookup" class="table table-bordered table-hover table-striped">
                 ...
                 <td><center><?php echo $i; ?></center></td>     
                    <td><center><?php echo $datas['nomor_trx'];?></center></td>
                      ...
                      <td><center><?php $harga = $datas['jumlah']; echo number_format($harga,0,".","."); ?></center></td>
                  ...
                  ?>
                   ...
                   <th colspan="2" class="text-center">Total </th>
                                    ...
                                    <td><center>Rp.<?php echo  number_format($subtotals,0,".","."); ?></center></td>
                    ...
                    <?php 
                      ...
                      ?>
                       ...
                       <h4>Total Laba (Kas Masuk - Kas Keluar) <b>
