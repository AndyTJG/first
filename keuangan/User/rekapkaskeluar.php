      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Laporan Rekaptulasi Kas Keluar</li>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Laporan Rekaptulasi Kas Keluar</h3>
                 ...
                 <td><center><?php echo $i; ?></center></td>     
                  ...
                  ?>
                   ...
                   <th colspan="6" class="text-center">Total </th>
                                    ...
                                    <td><left>Rp.<?php echo $subtotal; ?></left></td>
...
<div class="text-right">
                  ...
                  <a href="cetak_laporan2.php?awal=<?php echo $mulai;?>&akhir=<?php echo $selesai;?>" target="_blank" class="btn btn-warning">Cetak</a>
