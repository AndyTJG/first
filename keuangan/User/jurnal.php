      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Laporan Jurnal Neraca Buku Besar</li>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Laporan Jurnal Neraca Buku Besar</h3>
        ...
        <div class="row">
          ...
          <table id="lookup" class="table table-bordered table-hover table-striped">
                ...
                <table id="lookup" class="table table-bordered table-hover table-striped">
                 ...
                 <td><center><?php echo $i; ?></center></td>     
                    <td><center><?php echo $datas['nomor_trx'];?></center></td>
                    
                    <td><center><?php echo $datas['kd_rekening'];?></center></td>

                  <td><center><?php echo $datas['nama_rekening'];?></center></td>
                    <td><center><?php echo $datas['keperluan'];?></center></td>

                     <td><center><?php echo $datas['tgl_keluar'];?></center></td>
                     
                      <td><?php $harga = $datas['jumlah']; echo number_format($harga,0,".","."); ?></td>
