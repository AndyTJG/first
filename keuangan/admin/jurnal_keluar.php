      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Laporan Jurnal Kas Keluar</li>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Laporan Jurnal Kas Keluar</h3>
            ...
            <?php
              if(isset($_GET['submit'])){
                ...
                $selesai = $_GET['akhir'];
                     ...
                     $sql="select * FROM tb_kaskeluar INNER JOIN pengguna ON tb_kaskeluar.id_user = pengguna.id_user AND tb_kaskeluar.tgl_keluar BETWEEN '$mulai' AND '$selesai' ORDER BY tb_kaskeluar.id_trx DESC";
          ...
          <table id="lookup" class="table table-bordered table-hover table-striped">
                  <thead>
                      ...
                      <th><center>No</center></th>
                        ...
                        <th><center>akun rekening</center></th>
                 ...
                 <td><center><?php echo $i; ?></center></td>     
                  ...
                  <td><center><?php echo $data['tgl_keluar'];?></center></td>
                    <td><center><?php echo $data['nomor_trx'];?></center></td>
                      ...
                      <td><left><?php echo $data['keterangan_keluar'];?><br>Kas</center></td>
                   
                      <td><center><?php $harga = $data['jumlah_keluar']; echo number_format($harga,0,".","."); ?></center></td>

 <td><center><br><?php $harga = $data['jumlah_keluar']; echo number_format($harga,0,".","."); ?></center></td>
...
<div class="text-right">
                  <a href="rekapkasmasuk.php" class="btn btn-sm btn-warning">Kembali <i class="fa 
