            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Input Data Kas Keluar</h3>
                </div><!-- /.box-header -->
<?php
...
$query = mysqli_query($conn, "SELECT max(nomor_trx) as max_kode FROM tb_kaskeluar");
...
$newKode = $str . sprintf("%03s", $no);
 ...
 ?>
    ...
    $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tb_kaskeluar WHERE  nomor_trx='$nomor_trx'"));

    if ($cek > 0){
    echo "<script>window.alert('nomor_trx  sudah ada')
    window.location='input_kaskeluar.php'</script>";
    }else {
    mysqli_query($koneksi, "INSERT INTO tb_kaskeluar (id_user,nomor_trx, keperluan, tgl_keluar, jumlah_keluar, keterangan_keluar) VALUES ( '$id_user','$nomor_trx',  '$keperluan', '$tgl_keluar', '$jumlah_keluar', '$keterangan_keluar')");
    echo "<script>window.alert('DATA BERHASIL DISIMPAN')
    window.location='kaskeluar.php'</script>";
    }
    }
                ...
                <div class="box-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input_kaskeluar.php" method="post" enctype="multipart/form-data" name="form1" id_brg="form1">
                   ...
                   <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="keperluan" type="text" id="keperluan" class="form-control" autocomplete="off" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                              ...
                              <div class="col-sm-4">
                                  <input name="tgl_keluar" type="date" id="tgl_keluar" class="form-control" autocomplete="off" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>

                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> jumlah_keluar </label>
                              <div class="col-sm-4">
                                  <input name="jumlah_keluar" type="number" id="jumlah_keluar" class="form-control" autocomplete="off" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                                ...
                                <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> keterangan_keluar </label>
                              <div class="col-sm-4">
                                  <input name="keterangan_keluar" type="text" id="keterangan_keluar" class="form-control" autocomplete="off" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="kaskeluar.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
