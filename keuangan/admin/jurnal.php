          ...
          <table id="lookup" class="table table-bordered table-hover table-striped">
                 ...
                 <td><center><?php echo $i; ?></center></td>     
                    <td><center><?php echo $data['nomor_trx'];?></center></td>
                      ...
                      <td><left>Kas <br> setoran</center></td>
                    <td><center><?php echo $data['tgl_masuk'];?></center></td>
                      <td><center><?php $harga = $data['jumlah']; echo number_format($harga,0,".","."); ?></center></td>

 <td><center><br><?php $harga = $data['jumlah']; echo number_format($harga,0,".","."); ?></center></td>
                
                    
                         <td><center>Setoran dari anggota <?php echo $data['nama_penyetor'];?></center></td>
