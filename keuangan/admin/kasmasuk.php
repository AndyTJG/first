  ...
  <body class="hold-transition skin-purple sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        $id = $_GET['id'];
        $cek = mysqli_query($koneksi, "SELECT * FROM tb_kasmasuk WHERE id_trx='$id'");
        if(mysqli_num_rows($cek) == 0){
          ...
          $delete = mysqli_query($koneksi, "DELETE FROM tb_kasmasuk WHERE id_trx='$id'");
          if($delete){
      ...
      ?>
<a href="input_kasmasuk.php" class="btn btn-sm btn-warning"><i class="fa fa-file"></i> Tambah Kas Masuk</a> <br /><br />
                  ...
                  <?php
                    ...
                    $query1="select * from tb_kasmasuk ";
                 ...
                 or nama like '%$qcari%'  ";
                  ...
                  <thead>
                    ...
                    <td><center><?php echo $data['tgl_masuk'];?></center></td>
                      <td><?php $harga = $data['jumlah']; echo number_format($harga,0,".","."); ?></td>
                   ...
                   <td><center><?php echo $data['keterangan'];?></center></td>
                        ...
                        <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Data " href="edit_kasmasuk.php?aksi=edit&id_trx=<?php echo $data['id_trx'];?>"><span class="glyphicon glyphicon-edit"></span></a>  

                           <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Cetak Nota " href="detailkas.php?aksi=edit&id_trx=<?php echo $data['id_trx'];?>" target="_blank"  ><span class="glyphicon glyphicon-print"></span></a>  



                         <a onclick="return confirm ('Yakin hapus kas masuk atas nama <?php echo $data['nama_penyetor'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data " href="kasmasuk.php?aksi=hapus&id=<?php echo $data['id_trx'];?>"><span class="glyphicon glyphicon-trash"></a></center>
