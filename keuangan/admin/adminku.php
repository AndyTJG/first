...
<a href="input_admin.php" class="btn btn-sm btn-warning"><i class="fa fa-file"></i> Tambah data</a> <br /><br />
                  ...
                  <?php
                    ...
                    $query1="select * from pengguna WHERE level='Admin' ORDER BY nama ASC";
                  ...
                  <thead>
                    ...
                    <td><center><?php echo $data['username'];?></center></td>
                      ...
                      <td><center><img src="<?php echo $data['gambar'] ?>" class="img-rounded" height="100" width="150" style="border: 2px solid #666666;" /></td>
                        ...
                        <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Data Admin" href="edit_admin.php?aksi=edit&id_user=<?php echo $data['id_user'];?>"><span class="glyphicon glyphicon-edit"></span></a>  

                         <a onclick="return confirm ('Yakin hapus <?php echo $data['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data admin" href="adminku.php?aksi=hapus&id=<?php echo $data['id_user'];?>"><span class="glyphicon glyphicon-trash"></a></center>
