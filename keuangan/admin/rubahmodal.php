      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Laporan Perubahan Modal</li>
...
<tr>
                      ...
                      <td width="700" colspan="1">Rp.<?php echo $subtotal; ?></td>
                      </tr>
                      <tr>
...
<tr>
                      ...
                      <td width="700" colspan="1">Rp.<?php echo $subtotals; ?></td>
                      </tr>
                      <tr>
                 ...
                 <?php 
                      ...
                      ?>
                       ...
                       <h4>Modal Yang Harus dikeluarkan<b>




                   <h1><b><span name="id_trx" type="text"  id="id_trx"   style="font-size: 50pt">Rp.<?php echo  number_format($labarugi,0,".","."); ?></span></b></h1>
