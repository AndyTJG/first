...
<html>
  ...
  <body class="hold-transition skin-purple sidebar-mini">
    <div class="wrapper">
      ...
      ?>
<a href="input_kaskeluar.php" class="btn btn-sm btn-warning"><i class="fa fa-file"></i> Tambah Kas Keluar</a> <br /><br />
                 ...
                 or nama like '%$qcari%'  ";
                  ...
                  <thead>
                   ...
                   <td><center><?php echo $data['keterangan_keluar'];?></center></td>
                        ...
                        <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Data " href="edit_kaskeluar.php?aksi=edit&id_trx=<?php echo $data['id_trx'];?>"><span class="glyphicon glyphicon-edit"></span></a>  

                         <a onclick="return confirm ('Yakin hapus kas keluar atas nomor_trx <?php echo $data['nomor_trx'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data " href="kaskeluar.php?aksi=hapus&id=<?php echo $data['id_trx'];?>"><span class="glyphicon glyphicon-trash"></a></center>
